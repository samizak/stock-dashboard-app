...
export default function MarketSummary() {
  ...
  function GetPercentageElement(changePercent: number) {
    if (changePercent > 0) {
      return (
        <div className="bg-green-900 text-green-400 text-sm px-2 py-1 rounded-md">
          {changePercent}%
        </div>
      );
    }
    return (
      <div className="bg-red-900 text-red-400 text-sm px-2 py-1 rounded-md">
        {changePercent}%
      </div>
    );
  }
  ...
  return (
    <div className="flex flex-col justify-center items-center gap-4 w-full">
      ...
      <div className="flex flex-col max-w-screen-xl w-full">
        <div className="text-gray-300 ml-2 mb-3 mt-4 text-left">
          Market Summary
        </div>
        ...
        <div className="grid grid-cols-3 gap-4 rounded-md border">
          <Table className="">
            <TableHeader className="">
              <TableRow className="">
                <TableHead className="h-6 px-4 text-center align-middle font-medium">
                  Symbol
                </TableHead>
                <TableHead className="h-6 px-4 text-center align-middle font-medium">
                  Price
                ...
                <TableHead className="h-6 px-4 text-right align-middle font-medium">
                  % Change
                </TableHead>
              </TableRow>
            </TableHeader>
